...
## Generated on : Sat Dec 21 03:09:19 2024
## Final product: ./SiMappedEngineVlib.lib
...
PRODUCT = ./SiMappedEngineVlib.lib
...
SRCS = $(START_DIR)/slprj/sim/SiMappedEngineV/SiMappedEngineV.c $(START_DIR)/slprj/sim/SiMappedEngineV/SiMappedEngineV_capi.c
...
OBJS = SiMappedEngineV.obj SiMappedEngineV_capi.obj
...
%.obj : $(START_DIR)/slprj/sim/SiMappedEngineV/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/SiMappedEngineV/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/SiMappedEngineV/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/SiMappedEngineV/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/SiMappedEngineV/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
SiMappedEngineV.obj : $(START_DIR)/slprj/sim/SiMappedEngineV/SiMappedEngineV.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SiMappedEngineV_capi.obj : $(START_DIR)/slprj/sim/SiMappedEngineV/SiMappedEngineV_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
