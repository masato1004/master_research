...
## Generated on : Sat Dec 21 03:10:03 2024
...
COMPILER_COMMAND_FILE     = Driveline_comp.rsp
CMD_FILE                  = Driveline.rsp
...
DEFINES_STANDARD = -DMODEL=Driveline -DNUMST=2 -DNCSTATES=18 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/Driveline/Driveline.c $(START_DIR)/slprj/sim/Driveline/Driveline_capi.c $(START_DIR)/slprj/sim/Driveline/Driveline_data.c
...
OBJS = Driveline.obj Driveline_capi.obj Driveline_data.obj
...
%.obj : $(START_DIR)/slprj/sim/Driveline/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/Driveline/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/Driveline/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/Driveline/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/Driveline/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Driveline.obj : $(START_DIR)/slprj/sim/Driveline/Driveline.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Driveline_capi.obj : $(START_DIR)/slprj/sim/Driveline/Driveline_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Driveline_data.obj : $(START_DIR)/slprj/sim/Driveline/Driveline_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
