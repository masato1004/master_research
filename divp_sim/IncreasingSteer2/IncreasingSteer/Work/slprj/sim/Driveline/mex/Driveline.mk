...
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Driveline_msf.mexw64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Driveline_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/Driveline/Driveline_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = Driveline_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/INOUEM~1/research/MASTER~1/divp_sim/INCREA~2/INCREA~1/Work/slprj/sim/DRIVEL~1/DRIVEL~1.LIB
...
Driveline_msf.obj : $(START_DIR)/slprj/sim/Driveline/Driveline_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
