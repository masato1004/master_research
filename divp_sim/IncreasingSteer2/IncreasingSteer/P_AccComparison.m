...
ylim([-0.45 0.45])
xlabel("Time \rm[s]");
ylabel("\ita_{z} \rm[m/s^2]");
fontname(gcf,"Times New Roman");
fontsize(gca,11,"points");
legend([az_com_p,az_pro_p],{'NMPC w/o \itU_{obs}','Proposed'},FontSize=8);
...
ylim([-0.45 0.45])
xlabel("Time \rm[s]");
ylabel("\ita_{y} \rm[m/s^2]");
fontname(gcf,"Times New Roman");
fontsize(gca,11,"points");
legend([ay_com_p,ay_pro_p],{'NMPC w/o \itU_{obs}','Proposed'},FontSize=8)
