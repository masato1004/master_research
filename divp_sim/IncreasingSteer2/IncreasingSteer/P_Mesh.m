...
termState = [50 0 0 0 0 0]; % [S ds ddS L dL ddL]
...
% new_path=[new_path(new_path(:,1)<start_x,:);[trajGlobal.Trajectory(:,1:2),repmat(new_path(k(1),3),length(trajGlobal.Trajectory),1)];new_path(new_path(:,1)>end_x,:)];
