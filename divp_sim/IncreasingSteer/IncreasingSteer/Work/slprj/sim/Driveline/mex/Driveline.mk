...
MODEL                   = Driveline
MODULES                 = Driveline_msf.c c_mexapi_version.c
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:Driveline_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = Driveline_msf.mexw64
MODELREF_LINK_LIBS        = C:\Users\masato\MATLAB\Projects\examples\IncreasingSteer\IncreasingSteer\Work\slprj\sim\Driveline\Drivelinelib.lib
...
Driveline_msf.obj : $(START_DIR)\slprj\sim\Driveline\Driveline_msf.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\sim\Driveline\Driveline_msf.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\sim\Driveline\Driveline_msf.c
