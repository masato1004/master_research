...
struct_bhbbFgPaiXNmRg0hUA42gC rtP_temp ; extern const n5wdhep3vv hmusoyi44o ;
...
struct_bhbbFgPaiXNmRg0hUA42gC * GlobalPrm_0 = ( struct_bhbbFgPaiXNmRg0hUA42gC
* ) NULL ; if ( ! ssGetModelRefGlobalParamData ( S , 0 , ( void * * ) ( &
GlobalPrm_0 ) ) ) return ; if ( GlobalPrm_0 != NULL ) { ( void ) memcpy ( & ( rtP_temp ) , GlobalPrm_0 , sizeof ( struct_bhbbFgPaiXNmRg0hUA42gC ) ) ; } }
#endif
