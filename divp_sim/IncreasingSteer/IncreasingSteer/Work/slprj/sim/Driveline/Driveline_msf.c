...
struct_oekNfjm6KeLp8vftXiwgaD rtP_temp ; extern const n5wdhep3vv hmusoyi44o ;
...
struct_oekNfjm6KeLp8vftXiwgaD * GlobalPrm_0 = ( struct_oekNfjm6KeLp8vftXiwgaD
* ) NULL ; if ( ! ssGetModelRefGlobalParamData ( S , 0 , ( void * * ) ( &
GlobalPrm_0 ) ) ) return ; if ( GlobalPrm_0 != NULL ) { ( void ) memcpy ( & ( rtP_temp ) , GlobalPrm_0 , sizeof ( struct_oekNfjm6KeLp8vftXiwgaD ) ) ; } }
#endif
