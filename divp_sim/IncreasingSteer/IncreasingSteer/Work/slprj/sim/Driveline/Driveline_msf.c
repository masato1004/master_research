...
struct_hFtzkwIyDan9Uw0DEd8s7D rtP_temp ; extern const n5wdhep3vv hmusoyi44o ;
...
struct_hFtzkwIyDan9Uw0DEd8s7D * GlobalPrm_0 = ( struct_hFtzkwIyDan9Uw0DEd8s7D
* ) NULL ; if ( ! ssGetModelRefGlobalParamData ( S , 0 , ( void * * ) ( &
GlobalPrm_0 ) ) ) return ; if ( GlobalPrm_0 != NULL ) { ( void ) memcpy ( & ( rtP_temp ) , GlobalPrm_0 , sizeof ( struct_hFtzkwIyDan9Uw0DEd8s7D ) ) ; } }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { n5qm5cab0up * dw = ( n5qm5cab0up * ) ssGetDWork ( S , 0 ) ; oakdhkzk5b * localX = ( oakdhkzk5b * ) ssGetContStates ( S ) ; djkfokdtse ( & ( dw -> rtm ) , & ( dw -> rtdw ) , localX ) ; } static void mdlReset ( SimStruct * S ) { n5qm5cab0up * dw = ( n5qm5cab0up * ) ssGetDWork ( S , 0 ) ; oakdhkzk5b * localX = ( oakdhkzk5b * ) ssGetContStates ( S ) ; aj1apekess ( & ( dw -> rtm ) , & ( dw -> rtdw ) , localX ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { n5qm5cab0up * dw = ( n5qm5cab0up * ) ssGetDWork ( S , 0 ) ; real_T const * i_kgi5os0pto = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_csaifa0wqa = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T * o_B_7_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_7_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_7_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_7_4 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_7_5 = ( real_T * ) ssGetOutputPortSignal ( S , 4 ) ; real_T * o_B_7_6 = ( real_T * ) ssGetOutputPortSignal ( S , 6 ) ; oakdhkzk5b * localX = ( oakdhkzk5b * ) ssGetContStates ( S ) ; l1pljxktrl * localXdis = ( l1pljxktrl * ) ssGetContStateDisabled ( S ) ; real_T const * i_i_nturmjt1an = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; if ( tid == 0 ) { Driveline ( & ( dw -> rtm ) , i_kgi5os0pto , i_csaifa0wqa , o_B_7_1 , o_B_7_2 , o_B_7_3 , o_B_7_4 , o_B_7_5 , o_B_7_6 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX , & ( dw -> rtzce ) , localXdis ) ; cyzpp4e52p ( & ( dw -> rtm ) , i_i_nturmjt1an , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 18 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetNumPeriodicContStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 6 , 7 ) ; if ( ! ssSetNumInputPorts ( S , 6 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 1 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_DOUBLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
...
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "Pa" , & unitIdReg ) ; if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetInputPortUnit ( S , 5 , unitIdReg ) ;
#endif
...
; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "N*m" , & unitIdReg ) ; if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetOutputPortUnit ( S , 5 , unitIdReg ) ;
#endif
...
; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "1" , & unitIdReg ) ; if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetOutputPortUnit ( S , 6 , unitIdReg ) ;
#endif
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( n5qm5cab0up ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { n5qm5cab0up * dw = ( n5qm5cab0up * ) ssGetDWork ( S , 0 ) ; oakdhkzk5b * localX = ( oakdhkzk5b * ) ssGetContStates ( S ) ; l1pljxktrl * localXdis = ( l1pljxktrl * ) ssGetContStateDisabled ( S ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } jnccjczqwr ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 2 , true ) , & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX , & ( dw -> rtzce ) , sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { n5qm5cab0up * dw = ( n5qm5cab0up * )
ssGetDWork ( S , 0 ) ; l1pljxktrl * localXdis = ( l1pljxktrl * )
ssGetContStateDisabled ( S ) ; mdlProcessParameters ( S ) ; igx4apxpta ( & ( dw
-> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) , localXdis ) ; }
...
o_B_7_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_7_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_7_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_7_4 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_7_5 = ( real_T * ) ssGetOutputPortSignal ( S , 4 ) ; real_T * o_B_7_6 = ( real_T * ) ssGetOutputPortSignal ( S , 6 ) ; oakdhkzk5b * localX = ( oakdhkzk5b * ) ssGetContStates ( S ) ; l1pljxktrl * localXdis = ( l1pljxktrl * ) ssGetContStateDisabled ( S ) ; if ( tid == PARAMETER_TUNING_TID ) { DrivelineTID2 ( & ( dw -> rtb ) ) ; } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 , tid ) || ssIsMinorTimeStep ( S ) ) { Driveline ( & ( dw -> rtm ) , i_kgi5os0pto , i_csaifa0wqa , o_B_7_1 , o_B_7_2 , o_B_7_3 , o_B_7_4 , o_B_7_5 , o_B_7_6 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX , & ( dw -> rtzce ) , localXdis ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { n5qm5cab0up * dw = ( n5qm5cab0up * ) ssGetDWork ( S , 0 ) ; real_T const * i_i_nturmjt1an = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; oakdhkzk5b * localX = ( oakdhkzk5b * ) ssGetContStates ( S ) ; if ( ssIsSampleHit ( S , 0 , tid ) ) { cyzpp4e52p ( & ( dw -> rtm ) , i_i_nturmjt1an , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX ) ; } return ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { n5qm5cab0up * dw = ( n5qm5cab0up
* ) ssGetDWork ( S , 0 ) ; int8_T const * i_paxhtx4ikk = ( int8_T * )
