...
localX -> obuuvimtvu ) ; dataAddr [ 1 ] = ( void * ) ( & localX -> h235wq4fsj
) ; dataAddr [ 2 ] = ( void * ) ( & localX -> lf5wmc502m ) ; dataAddr [ 3 ] =
( void * ) ( & localX -> peid1wqkia ) ; }
#endif
#ifndef HOST_CAPI_BUILD
...
systemTid [ ] , void * rootSysRanPtr , int rootTid ) { UNUSED_PARAMETER ( plpdajfsza ) ; UNUSED_PARAMETER ( localDW ) ; systemRan [ 0 ] = ( sysRanDType * ) rootSysRanPtr ; systemRan [ 1 ] = ( NULL ) ; systemRan [ 2 ] = ( NULL ) ; systemTid [ 1 ] = plpdajfsza -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 2 ] = plpdajfsza -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 0 ] = rootTid ; rtContextSystems [ 0 ] = 0 ; rtContextSystems [ 1 ] = 0 ; rtContextSystems [ 2 ] = 0 ; }
#endif
#ifndef HOST_CAPI_BUILD
