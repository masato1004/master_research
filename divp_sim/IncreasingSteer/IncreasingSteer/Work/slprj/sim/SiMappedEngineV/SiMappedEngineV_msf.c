...
mr_SiMappedEngineV_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( o2k4rz0uw5x ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { o2k4rz0uw5x * dw = ( o2k4rz0uw5x * ) ssGetDWork ( S , 0 ) ; fpgmc1blog * localX = ( fpgmc1blog * ) ssGetContStates ( S ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } fbspkqemka ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 2 , true ) , & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX , sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { } static void mdlOutputs ( SimStruct
* S , int_T tid ) { o2k4rz0uw5x * dw = ( o2k4rz0uw5x * ) ssGetDWork ( S , 0 )
; real_T * o_o_B_2_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ;
fpgmc1blog * localX = ( fpgmc1blog * ) ssGetContStates ( S ) ; if ( tid ==
PARAMETER_TUNING_TID ) { SiMappedEngineVTID2 ( & ( dw -> rtb ) ) ; } if ( tid
!= CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0
, tid ) || ssIsMinorTimeStep ( S ) ) { SiMappedEngineV ( o_o_B_2_1 , & ( dw
-> rtb ) , localX ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { o2k4rz0uw5x * dw = ( o2k4rz0uw5x * ) ssGetDWork ( S , 0 ) ; real_T const * i_i_i_plq14ufrxm = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; pj3vtlmlns ( & ( dw -> rtm ) , i_i_i_plq14ufrxm , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; return ; }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { o2k4rz0uw5x * dw = ( o2k4rz0uw5x * ) ssGetDWork ( S , 0 ) ; real_T const * i_i_i_plq14ufrxm = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; jgubm4xidl * localZCSV = ( jgubm4xidl * ) ssGetNonsampledZCs ( S ) ; a20sjwaowh ( & ( dw -> rtm ) , i_i_i_plq14ufrxm , & ( dw -> rtb ) , & ( dw -> rtdw ) , localZCSV ) ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { o2k4rz0uw5x * dw = ( o2k4rz0uw5x
* ) ssGetDWork ( S , 0 ) ; real_T const * i_ec0csx13uo = ( real_T * )
ssGetInputPortSignal ( S , 0 ) ; real_T const * i_i_i_plq14ufrxm = ( real_T *
) ssGetInputPortSignal ( S , 1 ) ; real_T * o_o_B_2_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; ih0mudozt1 * localXdot = ( ih0mudozt1 * )
ssGetdX ( S ) ; bmpf100lpn ( & ( dw -> rtm ) , i_ec0csx13uo ,
i_i_i_plq14ufrxm , o_o_B_2_1 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localXdot
) ; } static void mdlTerminate ( SimStruct * S ) { o2k4rz0uw5x * dw = ( o2k4rz0uw5x * ) ssGetDWork ( S , 0 ) ; po5zlrzzyd ( & ( dw -> rtm ) ) ; return ; }
...
mxCreateStructMatrix ( 1 , 1 , 6 , simStateFieldNames ) ; { const fpgmc1blog
* localX = ( const fpgmc1blog * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( fpgmc1blog ) ; mxArray * storedX = mxCreateNumericMatrix
...
mr_SiMappedEngineV_GetDWork ( ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss
, 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_SiMappedEngineV_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss
...
} mr_SiMappedEngineV_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss
