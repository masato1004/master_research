function dx = runge(x, u, d, g, A, B, E, Gmat, dt, r, wheel_traj_f,wheel_traj_r,mileage_f,mileage_r,dis_total)
    ...
    x2 = x+b1/2; d2 = find_disturbance(wheel_traj_f,wheel_traj_r,mileage_f,mileage_r,dis_total,d1,x2,dt/2,r);
    dx_disf =d2(5,1);
    dx_disr =d2(6,1);
    dz_disf =d2(7,1);
    dz_disr =d2(8,1);
    ...
    x3 = x+b2/2; d3 = find_disturbance(wheel_traj_f,wheel_traj_r,mileage_f,mileage_r,dis_total,d1,x3,dt/2,r);
    dx_disf =d3(5,1);
    dx_disr =d3(6,1);
    dz_disf =d3(7,1);
    dz_disr =d3(8,1);
    ...
    x4 = x+b3; d4 = find_disturbance(wheel_traj_f,wheel_traj_r,mileage_f,mileage_r,dis_total,d1,x4,dt,r);
    dx_disf =d4(5,1);
    dx_disr =d4(6,1);
    dz_disf =d4(7,1);
    dz_disr =d4(8,1);
