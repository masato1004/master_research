...
static const mxArray *b_emlrt_marshallOut(const struct3_T *u)
{
  static const int32_T i = 109;
  static const int32_T i1 = 1353;
  static const int32_T i2 = 386;
...
static const mxArray *c_emlrt_marshallOut(const struct4_T *u)
{
  ...
  static const int32_T b_iv1[2] = {11, 14};
  static const int32_T i1 = 11;
  static const int32_T i2 = 22;
...
static void l_emlrt_marshallIn(const mxArray *src,
                               const emlrtMsgIdentifier *msgId, real_T ret[109])
{
  static const int32_T dims = 109;
  real_T(*r)[109];
  int32_T i;
  emlrtCheckBuiltInR2012b(emlrtRootTLSGlobal, msgId, src, "double", false, 1U,
                          (const void *)&dims);
  r = (real_T(*)[109])emlrtMxGetData(src);
  for (i = 0; i < 109; i++) {
    ret[i] = (*r)[i];
  }
  emlrtDestroyArray(&src);
...
static void m_emlrt_marshallIn(const mxArray *src,
                               ...
                               real_T ret[1353])
{
  static const int32_T dims = 1353;
  real_T(*r)[1353];
  int32_T i;
  emlrtCheckBuiltInR2012b(emlrtRootTLSGlobal, msgId, src, "double", false, 1U,
                          (const void *)&dims);
  r = (real_T(*)[1353])emlrtMxGetData(src);
  for (i = 0; i < 1353; i++) {
    ret[i] = (*r)[i];
  }
  emlrtDestroyArray(&src);
...
static void n_emlrt_marshallIn(const mxArray *src,
                               const emlrtMsgIdentifier *msgId, real_T ret[386])
{
  static const int32_T dims = 386;
  real_T(*r)[386];
  int32_T i;
  emlrtCheckBuiltInR2012b(emlrtRootTLSGlobal, msgId, src, "double", false, 1U,
                          (const void *)&dims);
  r = (real_T(*)[386])emlrtMxGetData(src);
  for (i = 0; i < 386; i++) {
    ret[i] = (*r)[i];
  }
  emlrtDestroyArray(&src);
