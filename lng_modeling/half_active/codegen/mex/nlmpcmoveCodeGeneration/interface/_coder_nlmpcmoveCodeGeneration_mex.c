                 ...
                 const mxArray *prhs[])
{
  ...
  unsafe_nlmpcmoveCodeGeneration_mexFunction(d_nlmpcmoveCodeGenerationStackD,
                                             nlhs, plhs, nrhs, prhs);
  /* Module termination. */
...
void unsafe_nlmpcmoveCodeGeneration_mexFunction(
    c_nlmpcmoveCodeGenerationStackD *SD, int32_T nlhs, mxArray *plhs[3],
