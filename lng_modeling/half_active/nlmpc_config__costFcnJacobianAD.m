...
%   を計算します。
%
%   2024/05/07 03:20:53 に prob2struct により自動生成
...
if nargout > 1
    ...
    ejac = zeros(3, 1);
    arg19 = 1;
    ejac = ejac + optim.coder.problemdef.gradients.mtimes.MtimesRightAdjoint(arg18, [3 1], arg19);
    arg20 = optim.coder.problemdef.gradients.mtimes.MtimesLeftAdjoint([1 3], e, arg19);
    arg21 = optim.coder.problemdef.gradients.mtimes.MtimesLeftAdjoint([1 3], arg17, arg20);
    arg22 = (arg21.*arg15(:));
    ejac = ejac + optim.problemdef.gradients.indexing.TransposeAdjoint(arg22,[1 3]);
